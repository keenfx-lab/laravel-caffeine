...
## Attention!
This is a forked Laravel Caffeine package separated from upstream repository to fix Log.warnings while waiting for jenssegers/model to be updated. This package uses a similarly forked jenssegers/model with a patch created by Mike Bronner. This is a temporary solution to overflowing error logs.
